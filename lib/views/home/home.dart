...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getDirections() async {
    try {
      ...
      if (_model != null) {
        ...
        showSnackBar(
            context: context,
            content: "Something went wrong, couldn't load route");
      }
    } catch (e) {
  ...
  Future<void> setInitCameraPos() async {
    ...
    determinePosition()
        ...
        .whenComplete(() async {
          try {
            await DatabaseService()
                .postCityId(latLng: LatLng(pos!.latitude, pos!.longitude))
  ...
  void _goToCurrLocation() async {
    ...
    if (coord != null) {
      ...
      showSnackBar(context: context, content: "Cannot access current location");
    }
